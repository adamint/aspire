...
export interface CodeGeneration_TypeScript_TestsAddTestRedisOptions {
    port?: number;
}

export interface CodeGeneration_TypeScript_TestsGetStatusAsyncOptions {
    cancellationToken?: AbortSignal | CancellationToken;
}

export interface CodeGeneration_TypeScript_TestsWaitForReadyAsyncOptions {
    cancellationToken?: AbortSignal | CancellationToken;
}

export interface CodeGeneration_TypeScript_TestsWithDataVolumeOptions {
    name?: string;
    isReadOnly?: boolean;
}

export interface CodeGeneration_TypeScript_TestsWithMergeLoggingOptions {
    enableConsole?: boolean;
    maxFiles?: number;
}

export interface CodeGeneration_TypeScript_TestsWithMergeLoggingPathOptions {
    enableConsole?: boolean;
    maxFiles?: number;
}

export interface CodeGeneration_TypeScript_TestsWithOptionalCallbackOptions {
    callback?: (arg: TestCallbackContext) => Promise<void>;
}

export interface CodeGeneration_TypeScript_TestsWithOptionalStringOptions {
    value?: string;
    enabled?: boolean;
}

export interface CodeGeneration_TypeScript_TestsWithPersistenceOptions {
...
export interface TestDatabaseResource {
     ...
     * @param options Additional options.
     */
    withDataVolume(options?: CodeGeneration_TypeScript_TestsWithDataVolumeOptions): TestDatabaseResourcePromise;
...
class TestRedisResourceImpl extends ResourceBuilderBase<TestRedisResourceHandle> implements TestRedisResource {
     ...
     * @param options Additional options.
     */
    async getStatusAsync(options?: CodeGeneration_TypeScript_TestsGetStatusAsyncOptions): Promise<string> {
     ...
     * @param options Additional options.
     */
    async waitForReadyAsync(timeout: number, options?: CodeGeneration_TypeScript_TestsWaitForReadyAsyncOptions): Promise<boolean> {
        const cancellationToken = options?.cancellationToken;
