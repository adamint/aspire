...
public class DotNetTemplateFactoryTests
{
    ...
    private sealed class TestDotNetCliRunner : IDotNetCliRunner
    {
        ...
        public Task<(int ExitCode, NuGetPackageCli[]? Packages)> SearchPackagesAsync(DirectoryInfo workingDirectory, string query, bool prerelease, bool exactMatch, int take, int skip, FileInfo? nugetConfigFile, bool useCache, ProcessInvocationOptions options, CancellationToken cancellationToken)
            => throw new NotImplementedException();
