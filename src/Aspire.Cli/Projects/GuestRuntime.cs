...
internal sealed class GuestRuntime
{
    ...
    /// <param name="cancellationToken">Cancellation token.</param>
    /// <param name="beforeExecuteAsync">Callback invoked after pre-execute commands succeed and before the AppHost execute command starts.</param>
    ...
    public async Task<(int ExitCode, OutputCollector? Output)> RunAsync(
        ...
        Func<Task>? beforeExecuteAsync = null)
    {
        ...
        return await ExecuteCommandAsync(commandSpec, appHostFile, directory, environmentVariables, null, phase, launcher, cancellationToken, beforeExecuteAsync: beforeExecuteAsync);
    }
        ...
        Func<Task>? beforeExecuteAsync = null)
    {
        ...
        {
            await beforeExecuteAsync().ConfigureAwait(false);
        }
