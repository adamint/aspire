...
export const debuggerExtensionDisabled = (debuggerName: string) => vscode.l10n.t('The {0} debugger extension is disabled. Enable it in VS Code, then restart the AppHost to enable debugging.', debuggerName);
