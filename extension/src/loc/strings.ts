...
export const hotReloadActiveNotice = vscode.l10n.t('.NET Hot Reload is turned on in C# Dev Kit, so it can apply to the .NET resources you debug in this Aspire app, where Dev Kit supports it. Saving a file asks Dev Kit to apply supported edits to a debugged resource without restarting it, and the Hot Reload button applies pending edits. Dev Kit reports what it actually applied in the .NET Hot Reload output.');
export const hotReloadActiveNoticeSaveDisabled = vscode.l10n.t('.NET Hot Reload is turned on in C# Dev Kit, so it can apply to the .NET resources you debug in this Aspire app, where Dev Kit supports it, but \'csharp.debug.hotReloadOnSave\' is turned off, so saving does not apply edits. Use the Hot Reload button to apply pending edits. Dev Kit reports what it actually applied in the .NET Hot Reload output.');
