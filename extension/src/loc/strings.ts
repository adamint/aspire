...
export const rustBuildProducedMultipleExecutables = (workingDirectory: string, targets: string) => vscode.l10n.t('cargo build in {0} could not determine which target to debug. Available targets: {1}. Pass the --bin or --example option with WithCargoArgs to specify one.', workingDirectory, targets);
